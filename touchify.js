...
$.fn.touchify = function(o) {
	...
	if (typeof o.swipe == 'undefined') o.swipe = false;
	if (typeof o.preventDefault == 'undefined') o.preventDefault = false;
	if (typeof o.stopPropagation == 'undefined') o.stopPropagation = false;
	if (typeof o.axis == 'undefined') o.axis = [ 'x' ];
	return this.each(function(){
		...
		var touchTarget = $(this),
			...
			onTouchStart = function(e) {
				...
				// Prevent dragging
				if (!touchEnabled || o.preventDefault) {
					e.preventDefault();
				}
